 ...
 * @author fabricio
 */
public class TelaAdministrador1 extends javax.swing.JFrame {
    ...
    public TelaAdministrador1(ClienteRepository clienteRepository,PerfilRepository perfilRepository,UsuarioRepository usuarioRepository,UsuarioService usuarioService) {
    ...
    /**
     * Creates new form TelaAdministrador1
     */
    
    private TelaAdministrador1(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAdministrador1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAdministrador1().setVisible(true);
            }
        });
    }
